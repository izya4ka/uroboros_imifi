...
db_client.connect().then((db_con) => {
  ...
  /*
   * Вверху есть список lessons с информацией о парах, 
   * как-то можно использовать данные оттуда.
   * Попробуешь погуглить типа в духе "how to get current date and time in Node.js with TypeScript"
   * и всё в таком духе. Будут вопросы - пиши/звони
   */
